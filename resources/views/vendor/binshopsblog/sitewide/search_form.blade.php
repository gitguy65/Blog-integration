<div style='max-width:500px;margin:50px auto;' class='search-form-outer'>
    ...
    <form method='get' action='{{ route("binshopsblog.search", app('request')->get('locale', 'en')) }}' class='text-center'>
    {{-- <form method='get' action='{{route("binshopsblog.search", 'en')}}' class='text-center'> --}}
